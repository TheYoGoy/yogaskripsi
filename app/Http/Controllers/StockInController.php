        ...
        try {
            DB::transaction(function () use ($validated) {
                ...
                StockIn::create([
                    ...
                    'supplier' => $validated['supplier_id'] ? Supplier::find($validated['supplier_id'])->name : null,
    ...
    public function autofill($code)
    {
        try {
            if (str_starts_with($code, 'INV-')) {
                ...
                // QR Product -> cari dari Product
                $product = Product::where('code', $code)->with('supplier')->first();
